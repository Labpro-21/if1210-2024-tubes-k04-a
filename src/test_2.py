...
file_user = "D:\\Uni\\TPB\\Semester 2\\Daspro\\if1210-2024-tubes-k04-a\\data\\test_folder\\user_test1.csv"
data_user = read_csv(file_user) # data user berupa id dan currency

file_monster = "D:\\Uni\\TPB\\Semester 2\\Daspro\\if1210-2024-tubes-k04-a\\data\\test_folder\\monster_test1.csv"
data_monster = read_csv(file_monster) # data monster berupa atk power, def power, dan hp

file_monster_inventory = "D:\\Uni\\TPB\\Semester 2\\Daspro\\if1210-2024-tubes-k04-a\\data\\test_folder\\monster_inventory_test1.csv"
data_monster_inventory = read_csv(file_monster_inventory) # data monster yang dimiliki tiap user dan levelnya

file_item_inventory = "D:\\Uni\\TPB\\Semester 2\\Daspro\\if1210-2024-tubes-k04-a\\data\\test_folder\\item_inventory.csv"
